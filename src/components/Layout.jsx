...
const Layout = () => {
  ...
  const [isNotificationDropdownOpen, setIsNotificationDropdownOpen] =
    useState(false);
  const [isSmallScreenSearchOpen, setIsSmallScreenSearchOpen] =
    useState(false);
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      {/* Sidebar */}
      <div
        className={`fixed top-0 bottom-0 left-0 z-50 w-64 bg-white text-black shadow-lg transform transition-transform duration-300 ease-in-out ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
      ...
      <div className="flex flex-col flex-grow overflow-hidden">
        {/* Navbar */}
        <nav className="sticky top-0 z-10 bg-white shadow px-4 py-2 flex items-center justify-between">
          {/* Sidebar Toggle */}
          <button
          ...
          {/* Title */}
          <h1 className="text-lg xl:text-2xl font-semibold">Admin Dashboard</h1>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              >
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRL6CrEfs7pimFavk_Z-xF2NaZwSiRbyM7dRVv6P3FXYXzWNKlWGhRTkUfFyNanGSj0WjM&usqp=CAU"
                  alt="Profile"
